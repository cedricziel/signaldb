...
| **mcp-server**        | `src/mcp-server/`      | Binary + Library | Standalone Model Context Protocol server (`signaldb-mcp`); credential-forwarding client over `signaldb-sdk`, serves MCP at `/mcp`                                        |
