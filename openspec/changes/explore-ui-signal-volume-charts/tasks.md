...
- [ ] 7.1 `pnpm --filter ... test` (or the repo's UI test script) green; run
...
- [ ] 7.3 Confirm no Rust crate changed and no OpenAPI/SDK regeneration was
      needed.

## 8. Documentation

- [ ] 8.1 Update the explore-UI user documentation for the scale control and
