...
| GET    | `/api/v1/connection`                        | Public ingest/query endpoints, headers, required scopes, and OTel env vars for this deployment, scoped to the caller's tenant/dataset | `connection_info`        | `connection_info`                                                                |
