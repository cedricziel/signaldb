...
set -euo pipefail
cd "$(dirname "$0")"
COMPONENTS="AttributeKeyInput AttributeTable AttributeValue BrandMark ConfirmButton CopyValueButton Dialog EmptyState MobileSidebarDrawer QueryError SemanticKey SidebarResizer SourceSnippet StacktraceLines VizTooltip"
