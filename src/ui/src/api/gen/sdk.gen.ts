 ...
 */
export const sessionConfig = <ThrowOnError extends boolean = false>(options?: Options<SessionConfigData, ThrowOnError>): RequestResult<SessionConfigResponses, unknown, ThrowOnError> => (options?.client ?? client).get<SessionConfigResponses, unknown, ThrowOnError>({ url: '/ui/session/config', ...options });
